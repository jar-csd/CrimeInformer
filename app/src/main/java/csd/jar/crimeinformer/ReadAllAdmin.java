...
public class ReadAllAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserAdapter userAdapter = new UserAdapter(this, crimeString, categoryStrings, dateStrings);
